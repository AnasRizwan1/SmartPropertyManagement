...
public class GeminiApi {
    private static final String API_KEY = "AIzaSyDUZ3RQ_dsvcpf4pRS8Vx2dhef4N-M-_us";
    // Corrected URL with v1beta
    ...
    public static void getGeminiResponse(String userPrompt, Consumer<String> callback) {
        new Thread(() -> {
            try {
                ...
                System.out.println("Full response from Gemini API: " + responseJson.toString());
